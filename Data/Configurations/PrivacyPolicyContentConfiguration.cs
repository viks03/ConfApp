...
namespace ConferenceApp.Data.Configurations
{
    public class PrivacyPolicyContentConfiguration : IEntityTypeConfiguration<PrivacyPolicyContent>
    {
        ...
        {
            // The single Privacy Policy / GDPR row, migrated one for one from
            // the old Pages.Privacy.en/bg.resx files so that nothing changed on
            // screen the day this shipped. From here on it is edited in the
            // admin panel, not in resx.
            builder.HasData(
