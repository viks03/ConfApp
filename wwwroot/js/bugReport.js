...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function openModal() {
            ...
            // This used to be body.style.overflow alone, which does not stop
            // a finger dragging the page on iOS. ConfApp.lockScroll in
            // common.js is the shared mechanism.
            window.ConfApp.lockScroll(true);
        ...
        function closeModal() {
            ...
            window.ConfApp.lockScroll(false);
