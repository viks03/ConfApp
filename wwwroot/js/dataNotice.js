...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // ── Body scroll lock ─────────────────────────────────────────────
        //    The position:fixed mechanism that used to live here (with the
        //    iOS Safari note and the behavior:'instant' restore) is now the
        //    shared ConfApp.lockScroll in common.js — the other three modals
        //    on the site used to do this three different ways and none of
        //    them knew about the iOS bug. See common.js for the full note.
        function lockBodyScroll()   { window.ConfApp.lockScroll(true); }
        function unlockBodyScroll() { window.ConfApp.lockScroll(false); }
