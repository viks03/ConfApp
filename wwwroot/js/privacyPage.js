...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // The page's own progress bar is gone: the global ambient layer draws
        // one on every page (--gfx-bar-height). Two bars on top of each other
        // are both duplicated work on every scroll and a visual duplicate.
